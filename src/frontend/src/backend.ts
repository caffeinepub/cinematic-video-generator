...
import type { VideoRecord as _VideoRecord } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async generateVideo(arg0: string, arg1: string): Promise<{
        __kind__: "ok";
        ok: VideoRecord;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.generateVideo(arg0, arg1);
    ...
    async getHistory(): Promise<Array<VideoRecord>> {
        if (this.processError) {
            try {
    ...
    async hasFalKey(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasFalKey();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setFalKey(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setFalKey(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
